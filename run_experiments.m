...
for i=1:length(sigmas)  
    ...
    [xx_cost(1,i),uu_cost(1,i)]=Table_Simulation("vaniila_dynamics","ctc",sigmas(1),n_sample, count);
    ...
    count=2;
    [xx_cost(2,i),uu_cost(2,i)]=Table_Simulation("qr_decomposed","ctc",sigmas(i),n_sample, count);
    xx_metric= array2table(xx_cost', 'VariableNames', {'ctc_vanilla', 'ctc_qr','vaniila_clqr','qr_clqr'},'RowNames' , {'0.0001', '0.001','0.01', '0.1'});
    uu_metric= array2table(uu_cost', 'VariableNames', {'ctc_vanilla', 'ctc_qr','vaniila_clqr','qr_clqr'},'RowNames' , {'0.0001', '0.001','0.01', '0.1'});
    save('cheetah_experiment.mat','xx_metric','uu_metric')
    ...
    count=3;
    [xx_cost(3,i),uu_cost(3,i)]=Table_Simulation("vaniila_dynamics","clqr",sigmas(i),n_sample, count);
    xx_metric= array2table(xx_cost', 'VariableNames', {'ctc_vanilla', 'ctc_qr','vaniila_clqr','qr_clqr'},'RowNames' , {'0.0001', '0.001','0.01', '0.1'});
    uu_metric= array2table(uu_cost', 'VariableNames', {'ctc_vanilla', 'ctc_qr','vaniila_clqr','qr_clqr'},'RowNames' , {'0.0001', '0.001','0.01', '0.1'});
    save('cheetah_experiment.mat','xx_metric','uu_metric')
    ...
    count=4;
    [xx_cost(4,i),uu_cost(4,i)]=Table_Simulation("qr_decomposed","clqr",sigmas(i),n_sample, count);
